...
- Current configurations are based on `Wed. May 10th 2023` updates.
- Current configurations that we are using in our working flow.
 - Support for `Github` theme.
 - Adding support for including `TabNine` AI-completion.
 - Auto-server loader which makes it super fast at startup.
 - Support for `user-config` for many options.


```emacs-lisp

;; -*- mode: emos-lisp; lexical-binding: t -*-
...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '((use-package)
                                      (use-package company-tabnine ;; for using tab-nine AI auto-assistance
                                        :ensure t
                                        :config
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-which-key-delay 3.0 ;;0.4
...
before packages are loaded."
  ...
  (setq mouse-wheel-scroll-amount '(1 ((shift) . 10) ((control) . nil)))
  ...
  ;; spell-check layer as well
  ;; beacon mode to allow it to be loaded
  (beacon-mode 1)
  ...
  ;; -------------------- Adding function to hover on definition ------------
  ...
  ;; ---------------- For showing documentation on hover ----------------
  ...
  ;; (define-key evil-normal-state-map (kbd "gh") (lambda () (interactive) (lsp-ui-doc-show)))
  ;; (define-key evil-normal-state-map (kbd "gh") (lambda ()
  ;;                                                (interactive)
