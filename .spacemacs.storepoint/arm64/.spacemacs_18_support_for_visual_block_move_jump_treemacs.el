...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Fantasque Sans Mono" ;;"Iosevka", "VictorMono Nerd Font" ; SpaceMono Nerd Font
                               ;;:size 15.0
                               :size 16.0
                               :weight Regular ;; bold,light,semibold,medium,demibold
...
(custom-set-variables
 ...
 '(org-export-backends '(ascii html icalendar latex md odt))
 '(package-selected-packages
   '(markdownfmt treemacs-all-the-icons yasnippet-snippets yapfify yaml-mode
                 ws-butler writeroom-mode winum which-key web-mode web-beautify
                 volatile-highlights vmd-mode vim-powerline vi-tilde-fringe
                 uuidgen unicode-fonts unfill undo-tree treemacs-tab-bar
                 treemacs-projectile treemacs-persp treemacs-nerd-icons
                 ...
                 rustic ron-mode reveal-in-osx-finder restart-emacs ranger
                 rainbow-mode rainbow-identifiers rainbow-delimiters quickrun
                 pytest pylookup pyenv-mode pydoc py-isort pug-mode prettier-js
                 popwin poetry pippel pipenv pip-requirements pdf-view-restore
                 password-generator paradox overseer osx-trash osx-dictionary
                 osx-clipboard orgit-forge org-superstar org-rich-yank
                 org-projectile org-present org-pomodoro org-mime org-make-toc
                 org-download org-contrib org-cliplink org-bullets
                 open-junk-file npm-mode nose nord-theme nodejs-repl
                 nerd-icons-ibuffer nameless mwim multi-vterm multi-term
                 multi-line mmm-mode minimap markdown-toc magit-todos macrostep
                 lsp-ui lsp-python-ms lsp-pyright lsp-origami lsp-latex
                 lorem-ipsum livid-mode live-py-mode link-hint ligature
                 launchctl keycast json-reformat json-navigator json-mode
                 js2-refactor js-doc inspector info+ indent-guide importmagic
                 impatient-mode ibuffer-projectile hybrid-mode hungry-delete
                 holy-mode highlight-parentheses highlight-numbers
                 ...
                 helm-ls-git helm-icons helm-git-grep helm-descbinds helm-ctest
                 ...
                 git-link gh-md gendoxy fuzzy flyspell-correct-helm
                 flycheck-ycmd flycheck-rtags flycheck-pos-tip flycheck-package
                 flycheck-elsa flx-ido fancy-battery eyebrowse expand-region
                 evil-visualstar evil-visual-mark-mode evil-unimpaired
                 evil-tutor evil-textobj-line evil-tex evil-surround evil-snipe
                 ...
                 dotenv-mode doom-themes dockerfile-mode docker disaster
                 dired-quick-sort diminish diff-hl devdocs dap-mode cython-mode
                 csv-mode cpp-auto-include company-ycmd company-web
                 company-tabnine company-statistics company-rtags company-reftex
                 company-quickhelp company-math company-lua company-c-headers
                 company-auctex company-anaconda command-log-mode
                 column-enforce-mode color-identifiers-mode code-cells
                 cmake-mode clean-aindent-mode centered-cursor-mode centaur-tabs
                 ccls browse-at-remote bm blacken beacon auto-yasnippet
                 auto-highlight-symbol auto-dictionary auto-compile
                 auctex-latexmk all-the-icons-dired all-the-icons-completion
...
(custom-set-faces
 ...
 '(markdown-header-face-4 ((t (:inherit bold :foreground "#ef5552" :height 1.1))))
 '(markdown-header-face-5 ((t (:inherit bold :foreground "#4051b5" :height 1.1))))
 '(markdown-pre-face ((t (:foreground "#FBCE9D"))))
 '(markdown-url-face ((t (:foreground "#96d0ff"))))
 '(org-agenda-date-today ((t (:inherit org-agenda-date :weight bold :foreground "#00A6FB" :height 1.5))))
 '(org-checkbox ((t (:foreground "#98B6B1"))))
 '(org-code ((t (:inherit (shadow fixed-pitch) :foreground "#FBCE9D" :weight bold :height 1.1))))
