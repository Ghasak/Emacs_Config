...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (python :variables
             python-backend 'anaconda ;; There are two options: 'ananconda and (default) 'lsp (python-lsp-server package)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner (concat user-emacs-directory "banner/pngwing.png")
