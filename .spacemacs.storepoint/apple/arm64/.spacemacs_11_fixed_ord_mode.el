  ...
  (setq-default
   ...
   '(lua
     ...
     (auto-completion :variables
                      ...
                      ;;spacemacs-default-company-backends '(company-files company-capf company-lsp company-yasnippet company-anaconda company-tabnine) ;; (default) to complete path/directory and
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("VictorMono Nerd Font" ;;"Iosevka", "VictorMono Nerd Font"
                               :size 15.0
                               :weight medium;; bold,light,semibold,medium,demibold
                               :width  narrow;; wide, narrow, expanded, condensed,
                               :powerline-scale 2.5
                               ;; :fallback "Isoevka SS04"
                               ;; :nerd "Isoevka SS04"
            ...
            (defun efs/org-mode-setup ()
              ...
              (defun efs/org-font-setup ()
                ...
                (dolist (face '((org-level-1 . 1.5)
                                ...
                                (org-level-8 . 1.1)))
                  ;; set the headers
                  (set-face-attribute (car face) nil :font "SF Pro" :weight 'regular :height 200)
                  ;; Set the fixed pitch face (tags, ~text~, =text=)
                  (set-face-attribute 'fixed-pitch nil :font "VictorMono Nerd Font" :height 150 :weight 'regular)
                  ;; Set the variable pitch face (text font )
                  (set-face-attribute 'variable-pitch nil :font "VictorMono Nerd Font" :height 150 :weight 'regular)
...
;;----------- to here ----------------
;;(helm-icons-enable)
(add-hook 'helm-mode-hook #'helm-icons-enable)
...
;; -------------------------------------------------------------
 ...
 '(yapfify yaml-mode xterm-color ws-butler winum which-key web-mode web-beautify volatile-highlights vmd-mode visual-fill-column vi-tilde-fringe uuidgen use-package unfill undo-tree queue treemacs-tab-bar treemacs-nerd-icons treemacs-icons-dired treemacs-evil treemacs-all-the-icons treemacs cfrs pfuture posframe toml-mode toc-org tagedit spaceline powerline smeargle slim-mode shell-pop scss-mode sass-mode reveal-in-osx-finder restart-emacs ranger rainbow-mode rainbow-identifiers rainbow-delimiters racer rust-mode pyvenv pytest pyenv-mode py-isort pug-mode popwin pip-requirements persp-mode pcre2el pbcopy paradox spinner ox-twbs ox-gfm osx-trash osx-dictionary orgit org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-plus-contrib org-mime org-download org-bullets open-junk-file nerd-icons-ibuffer nerd-icons neotree mwim multi-term move-text mmm-mode minimap markdown-toc magit-gitflow magit-popup magit magit-section macrostep lua-mode lorem-ipsum livid-mode skewer-mode simple-httpd live-py-mode linum-relative link-hint launchctl json-mode json-snatcher js2-refactor multiple-cursors js2-mode js-doc indent-guide ibuffer-projectile hydra lv hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-pydoc helm-projectile projectile helm-mode-manager helm-make helm-gitignore request git-modes helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag haml-mode google-translate golden-ratio gnuplot git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter git-commit with-editor gh-md fuzzy flyspell-correct-helm flyspell-correct flycheck-rust flycheck-pos-tip flycheck pkg-info epl flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-snipe evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-args evil-anzu anzu evil goto-chg eval-sexp-fu eshell-z eshell-prompt-extras esh-help engine-mode emmet-mode elisp-slime-nav dumb-jump dockerfile-mode docker-tramp docker transient tablist aio compat diminish diff-hl cython-mode csv-mode company-web web-completion-data company-tabnine company-statistics company-quickhelp pos-tip company-auctex company-anaconda company command-log-mode column-enforce-mode color-identifiers-mode coffee-mode clean-aindent-mode cargo markdown-mode bind-map bind-key beacon auto-yasnippet yasnippet auto-highlight-symbol ht auto-dictionary auto-compile auctex-latexmk auctex anaconda-mode pythonic f s all-the-icons-dired all-the-icons-completion all-the-icons aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core async ac-ispell auto-complete popup doom-themes dash)))
